...
//	Keys[1]->updateCurPos();
//
//	meshList[GEO_VENDINGMACHINE] = MeshBuilder::GenerateOBJ("vendingmachine", "OBJ//NPC//Vending_Machine.obj");
//	meshList[GEO_VENDINGMACHINE]->textureID = LoadTGA("Image//model//Vending_Machine.tga");
//	meshList[GEO_VENDINGCOVER] = MeshBuilder::GenerateOBJ("vendingcover", "OBJ//NPC//Vending_Cover.obj");
...
//}
//
//void Wilson::RenderMesh(Mesh *mesh, bool enableLight)
//{
...
//}
//
//void Wilson::RenderText(Mesh* mesh, std::string text, Color color)
//{
...
//}
//
//void Wilson::RenderTextOnScreen(Mesh* mesh, std::string text, Color color, float size, float x, float y)
//{
//	if (!mesh || mesh->textureID <= 0) //Proper error check
//		return;
//
...
//}
//
//void Wilson::RenderMeshOnScreen(Mesh* mesh, int x, int y, int sizex, int sizey)
//{
//	glDisable(GL_DEPTH_TEST);
//	Mtx44 ortho;
//	ortho.SetToOrtho(0, 80, 0, 60, -10, 10); //size of screen UI
