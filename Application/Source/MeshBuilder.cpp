...
Mesh* MeshBuilder::GenerateQuad(const std::string &meshName, Color color, float lengthX, float lengthY)
{
	...
	v.pos.Set(lengthX* 0.5f, lengthY*  0.5f, 0); v.color = color; v.normal.Set(0, 1, 0); v.texCoord.Set(1, 1); vertex_buffer_data.push_back(v);
	v.pos.Set(lengthX* -0.5f, lengthY* 0.5f, 0); v.color = color; color; v.normal.Set(0, 1, 0); v.texCoord.Set(0, 1);  vertex_buffer_data.push_back(v);
	v.pos.Set(lengthX* 0.5f, lengthY* -0.5f, 0); v.color = color; color; v.normal.Set(0, 1, 0); v.texCoord.Set(1, 0);  vertex_buffer_data.push_back(v);
	v.pos.Set(lengthX* -0.5f, lengthY* -0.5f, 0); v.color = color; color; v.normal.Set(0, 1, 0); v.texCoord.Set(0, 0);  vertex_buffer_data.push_back(v);
...
Mesh* MeshBuilder::GenerateGround(const std::string &meshName, Color color, float lengthX, float lengthY)
{
	...
	v.pos.Set(lengthX* 0.5f, lengthY*  0.5f, 0); v.color = color; v.normal.Set(0, 0, -1); v.texCoord.Set(100, 100); vertex_buffer_data.push_back(v);
	v.pos.Set(lengthX* -0.5f, lengthY* 0.5f, 0); v.color = color; color; v.normal.Set(0, 0, -1); v.texCoord.Set(0, 100);  vertex_buffer_data.push_back(v);
	v.pos.Set(lengthX* 0.5f, lengthY* -0.5f, 0); v.color = color; color; v.normal.Set(0, 0, -1); v.texCoord.Set(100, 0);  vertex_buffer_data.push_back(v);
